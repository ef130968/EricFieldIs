            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.avatarFile.label" default="Avatar File" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: userInstance, field: "avatarFile")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.citizen.label" default="Citizen" /></td>
                            
                            <td valign="top" class="value"><g:link controller="citizen" action="show" id="${userInstance?.citizen?.id}">${userInstance?.citizen?.encodeAsHTML()}</g:link></td>
