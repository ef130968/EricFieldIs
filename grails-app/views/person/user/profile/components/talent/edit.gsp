...
<g:link controller="skill" action="create" params="['talent.id': talentInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'skill.label', default: 'Skill')])}</g:link>
