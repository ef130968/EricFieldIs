...
<%@ page import="ericfieldis.profile.components.talent.Skill" %>
<html>
    <head>
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="talent" action="show" id="${skillInstance?.talent?.id}">${skillInstance?.talent?.encodeAsHTML()}</g:link></td>
