        ...
        <table>
            ...
            <tr>
                ...
                <g:sortableColumn property="description"
                                  title="${message(code: 'profile.description.label', default: 'Description')}"/>

                <g:sortableColumn property="profileType"
                                  title="${message(code: 'profile.profileType.label', default: 'Profile Type')}"/>
