    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${valueInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="description"><g:message code="value.description.label" default="Description" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: valueInstance, field: 'profile', 'errors')}">
                                    <g:select name="profile.id" from="${ericfieldis.profile.Profile.list()}" optionKey="id" value="${valueInstance?.profile?.id}"  />
                                </td>
                            </tr>
